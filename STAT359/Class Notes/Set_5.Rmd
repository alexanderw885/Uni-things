...
while the p-value is larger, it's still very unlikely that both distributions have the same mean. We have less confidence, but the p-value is still veyr small
