...
function makeKeys() {
    ...
    // converts coordinates in ds1 and ds2 into screen coordinates
    ...
    svg.selectAll( "text" )
        .data(ds1).enter().append( "text" ) // associate each data point with text element
    ...
    svg.on( "click", function() {
        var cs = svg.selectAll( "circle" ).data( ds2, d=>d[0] ); // select all circles where the match ds2, set ds2 as the new data
