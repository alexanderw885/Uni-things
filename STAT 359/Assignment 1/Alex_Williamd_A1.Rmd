...
### a)
```{r}
tv<-read.table(file="~/Documents/STAT 359/data/tv.txt",
               sep="",
               header=TRUE)
attach(tv)
...
summary(tv)
```
While the Canada watch time and the US watch time have similar means and medians, US watch time seems to have a much tighter distribution. 
